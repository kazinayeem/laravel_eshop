        ...
        <div class="page-holder">
            ...
            <header class="header bg-white">
                <div class="container px-lg-3">
                    <nav
                        class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"
                    >
                            ...
                            <ul class="navbar-nav ms-auto">
                                <li class="nav-item">
                                    <a class="nav-link" href="cart.html">
                                        <i
                                            class="fas fa-dolly-flatbed me-1 text-gray"
                                        ></i
                                        >Cart<small class="text-gray fw-normal"
                                            >(2)</small
                                        ></a
                                    >
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#!">
                                        <i
                                            class="fas fa-user me-1 text-gray fw-normal"
                                        ></i
                                        >Login</a
                                    >
                                </li>
...
<br>
            <!-- slider -->
        <div class="container">
        <div id="carouselExampleSlidesOnly" data-bs-config='{"delay":100, "title":123}' class="carousel slide m-auto" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/100899558_context.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="https://viterotiles.com/sites/default/files/2020-09/How-To-Clean-The-White-Granite-Flooring.png" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img/100899558_context.jpg" class="d-block w-100" alt="...">
    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-4 my-md-4">
                                        ...
                                        <p class="text-sm mb-4">
                                            ...
                                            consectetur adipiscing elit. In ut
                                        ...
                                        <div
                                            class="row align-items-stretch mb-4 gx-0"
                                        >
                                            <div class="col-sm-7">
                                                <div
                ...
                <section class="py-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="product text-center">
                                <div class="position-relative mb-3">
                                    <div class="badge text-white bg-primary">
                                        Sale
                                    </div>
                                    <a class="d-block" href="detail.html"
                                        ><img
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="product text-center">
                                <div class="position-relative mb-3">
                                    <div class="badge text-white bg-info">
                                        New
                                    </div>
                                    <a class="d-block" href="detail.html"
                                        ><img
                            ...
                            <div class="col-lg-4">
                                <div class="d-inline-block">
                                    <div class="d-flex align-items-end">
                                        <svg
                                            class="svg-icon svg-icon-big svg-icon-light"
                                        >
                                            <use
                                                xlink:href="#delivery-time-1"
                                            ></use>
                                        </svg>
                    ...
                    <div class="row py-5">
                        ...
                        <div class="col-md-4">
                            ...
                            <ul class="list-unstyled mb-0">
                                ...
                                <li>
                                    <a class="footer-link" href="#!">Tumblr</a>
                                </li>
                                <li>
                                    <a class="footer-link" href="#!"
                                        >Pinterest</a
